...
The following graph appeared. 

![Graph Big O](/docs/images/graph.png)


It is possible to conclude that the best sorting algorithm was the quick sort, with a very low execution time compared to the rest of the sorting methods. 
...
Also, the following results are shown along with the previous graph.
